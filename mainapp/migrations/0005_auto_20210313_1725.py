# Generated by Django 3.1.4 on 2021-03-13 13:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0004_auto_20210308_1939'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='orders', to='mainapp.Order', verbose_name='Заказы покупателя'),
        ),
    ]
